...
GLOBAL_CPPFLAGS += -DFREEBSD -DJ9HAMMER -D_REENTRANT -D_FILE_OFFSET_BITS=64
...
ifneq (,$(findstring executable,$(ARTIFACT_TYPE)))
  # Default Libraries
  GLOBAL_SHARED_LIBS+=m pthread c dl util kvm
...
$(CCLINKSHARED) -o $@ $(OBJECTS) $(LDFLAGS) $(MODULE_LDFLAGS) $(GLOBAL_LDFLAGS) -install_name lib$(MODULE_NAME).so
cp $@ $@.dbg
endef

define LINK_CXX_SHARED_COMMAND
$(CXXLINKSHARED) -o $@ $(OBJECTS) $(LDFLAGS) $(MODULE_LDFLAGS) $(GLOBAL_LDFLAGS) -install_name lib$(MODULE_NAME).so
cp $@ $@.dbg
endef
