 ...
 * ============================
 *
 * General loop unroller optimization can unroll or peel a majority of 
 ...
 * Peeling aids PRE as code does not have to be moved; instead dominated 
 * expressions can be commoned (which is far easier than code motion 
 * due to problems introduced by exception checks in Java).
 *
