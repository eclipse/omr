...
public:
	...
	void mainSetupForGC(MM_EnvironmentBase *envBase);
	void mainTeardownForSuccessfulGC(MM_EnvironmentBase* env);
	void mainTeardownForAbortedGC(MM_EnvironmentBase *env);
