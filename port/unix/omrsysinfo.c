...
#if (HOST_OS == OMR_LINUX) || defined(AIXPPC) || defined(J9ZOS390)
static intptr_t readSymbolicLink(struct OMRPortLibrary *portLibrary, char *linkFilename, char **result);
#endif /* (HOST_OS == OMR_LINUX) || defined(AIXPPC) || defined(J9ZOS390) */
...
#else /* (HOST_OS == OMR_LINUX) || defined(AIXPPC) */
	return -1;
...
#if defined(AIXPPC) || ((HOST_OS == OMR_LINUX) && !defined(OMRZTPF)) || (HOST_OS == OMR_OSX) || defined(J9ZOS390)
...
#else /* defined(AIXPPC) || ((HOST_OS == OMR_LINUX) && !defined(OMRZTPF)) || (HOST_OS == OMR_OSX) || defined(J9ZOS390) */
		/* unsupported on other platforms (just in case). */
		*limit = OMRPORT_LIMIT_UNKNOWN_VALUE;
		rc = OMRPORT_LIMIT_UNKNOWN;
#endif /* defined(AIXPPC) || ((HOST_OS == OMR_LINUX) && !defined(OMRZTPF)) || (HOST_OS == OMR_OSX) || defined(J9ZOS390) */
	}
	break;
	default:
...
omrsysinfo_get_CPU_utilization(struct OMRPortLibrary *portLibrary, struct J9SysinfoCPUTime *cpuTime)
{
	...
	return status;
#else /* ((HOST_OS == OMR_LINUX) && !defined(OMRZTPF)) || defined(AIXPPC) || (HOST_OS == OMR_OSX) */
