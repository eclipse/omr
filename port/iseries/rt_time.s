###############################################################################
# Copyright (c) 2002, 2015 IBM Corp. and others
# 
...
# IBM i runtime function: __getNanos
...
mftb_loop_nanos:                                ## get current ticks in r11, r12
     ...
     mftbu        r0
      ...
      cmpwi        cr0, r3, 0                   ## has Xint initialized??
      cmpwi        cr7, r9, 0                   ## has Xfraq initialized??
    mulhwu        r7, r12, r6
    ...
    mulhwu        r3, r12, r5
      ...
      beq-        refreshTime_nanos             ## branch if Xfrac changed
    ...
    mulhwu        r6, r11, r5
     ...
     addze        r7, r6
      ...
      beq-        cr7,refreshTime_nanos         ## branch if Xint not initialized
