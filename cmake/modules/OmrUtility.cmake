...
function(omr_get_target_path VAR tgt)
	...
	if(target_type STREQUAL "EXECUTABLE")
		...
		if(NOT target_name)
			get_target_property(target_name  ${tgt} OUTPUT_NAME)
		endif()
		if(NOT target_name)
			set(target_name "${tgt}")
		endif()
		set(target_name "${target_name}${CMAKE_EXECUTABLE_SUFFIX}")
	elseif(target_type STREQUAL "SHARED_LIBRARY")
		...
		set(target_name "${CMAKE_SHARED_LIBRARY_PREFIX}${target_name}${CMAKE_SHARED_LIBRARY_SUFFIX}")
	else()
