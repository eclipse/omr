...
#if (HOST_OS == OMR_LINUX) || defined(J9ZOS390) || defined(AIXPPC) || (HOST_OS == OMR_OSX)
#include <sys/types.h>
#include <sys/wait.h>
#include <unistd.h>
#include <sys/ipc.h>
...
#endif /* (HOST_OS == OMR_LINUX) || defined(J9ZOS390) || defined(AIXPPC) || (HOST_OS == OMR_OSX) */
...
#else /* (HOST_OS == OMR_LINUX) || defined(J9ZOS390) || defined(AIXPPC) || (HOST_OS == OMR_OSX) */
...
#elif (HOST_OS == OMR_LINUX) || defined(J9ZOS390) || defined(AIXPPC) || (HOST_OS == OMR_OSX)
	sleep(second);
#endif /* (HOST_OS == OMR_WINDOWS) */
}
