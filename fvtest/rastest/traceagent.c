...
#if defined(LINUX) || defined(AIXPPC) || defined(OMR_OS_WINDOWS) || defined(OSX) || defined(FREEBSD)
	if (OMR_ERROR_NONE == testRc) {
...
#endif /* defined(LINUX) || defined(AIXPPC) || defined(OMR_OS_WINDOWS) || defined(OSX) || defined(FREEBSD) */
	return testRc;
}
...
#elif !defined(LINUX) && !defined(OMR_OS_WINDOWS) && !defined(OSX) && !defined(FREEBSD)
	if (OMR_ERROR_NONE == testRc) {
