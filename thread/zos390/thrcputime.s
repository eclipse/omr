...
* or the Apache License, Version 2.0 which accompanies this 
* distribution and is available at 
* https://www.apache.org/licenses/LICENSE-2.0.
* 
* This Source Code is also Distributed under one or more Secondary 
* Licenses, as those terms are defined by the Eclipse Public 
* License, v. 2.0: GNU General Public License, version 2 with the 
* GNU Classpath Exception [1] and GNU General Public License,
